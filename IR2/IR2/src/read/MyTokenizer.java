...
import dictionary.ArrayTrie;
import dictionary.ArrayTrieIterativeOptimized;
import dictionary.TernaryTrie;
...
//				docIndex.add(td.doc, at.search(s));
			...
			System.out.println("Posting list size:\t"+at.getTrainSize()+" nodes.");
