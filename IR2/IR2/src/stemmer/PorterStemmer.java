...
public abstract class PorterStemmer {
	...
	static boolean hasSuffix( String word, String suffix, NewString stem ) {
	...
	static boolean vowel( char ch, char prev ) {
		switch ( ch ) {
	...
	static String stripPrefixes ( String str) {
	...
	{
		String s1 = PorterStemmer.step1(s);
        String s2 = PorterStemmer.step2(s1);
        String s3= PorterStemmer.step3(s2);
        String s4= PorterStemmer.step4(s3);
        String s5= PorterStemmer.step5(s4);

        return s5;
	}
	public static void main(String[] args)
	{
//		PorterStemmer PrterStemmer = new PorterStemmer();
		String i = new String("armin");
		String s1 = PorterStemmer.step1(i);
        String s2 = PorterStemmer.step2(s1);
        String s3= PorterStemmer.step3(s2);
        String s4= PorterStemmer.step4(s3);
        String s5= PorterStemmer.step5(s4);
