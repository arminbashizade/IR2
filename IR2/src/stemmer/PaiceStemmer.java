...
{
	public static final String RULES = "C:/Users/maxi/Desktop/Dropbox/AUT/Information Storage and Retrieval/IR2/paice rules.txt"; 
	 ...
	 *Purpose:	init		*
	 ********************************/
	public PaiceStemmer (String filePath, String pre)
	{
	...
	{
		PaiceStemmer p = new PaiceStemmer(RULES, "");
		System.out.println(p.stripAffixes("melika"));
		/*String text;
